...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const latestTag = (0, utils_1.getLatestTag)(validTags, prefixRegex, tagPrefix, latestTagFilter);
        const latestPrereleaseTag = (0, utils_1.getLatestPrereleaseTag)(validTags, identifier, prefixRegex, latestPrereleaseTagFilter);
        let commits;
        let newVersion;
        if (customTag) {
            ...
            if (!latestPrereleaseTag) {
                core.info(`latestPrereleaseTag not set, using latestTag.`);
